      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              child: FutureBuilder<List<TripManifestRow>>(
                future: db.getTripManifests(trip.id),
    ...
    return SingleChildScrollView(
      ...
      child: DataTableTheme(
        ...
        child: DataTable(
          ...
          columns: [
            DataColumn(label: header('Date', Format.date(trip.date))),
...
class _ManifestsTable extends StatefulWidget {
  ...
  final List<TripManifestRow> items;
                  ...
                  child: DataTableTheme(
                    ...
                    child: DataTable(
                      ...
                      columns: [
                        ...
                        DataColumn(label: Text('Delivery City', style: headerStyle)),
                        DataColumn(
                          label: SizedBox(
                            width: AppTableWidths.phone,
                            child: Center(child: Text('Phone', style: headerStyle)),
                          ),
                        ),
                        DataColumn(
                          label: SizedBox(
                            width: AppTableWidths.parcelType,
                            child: Center(child: Text('Parcel Type', style: headerStyle)),
                          ),
                        ),
                        DataColumn(
                          label: SizedBox(
                            width: AppTableWidths.number,
                            child: Center(child: Text('Number of Parcel', style: headerStyle)),
                          ),
                        ),
                        DataColumn(
                          label: SizedBox(
                      ...
                      rows: [
                        ...list.asMap().entries.map((e) {
                          ...
                          return DataRow(
                            ...
                            cells: [
                              ...
                              DataCell(Text(m.customerName ?? '-', style: cellStyle)),
                              DataCell(Text(m.deliveryCity ?? '-', style: cellStyle)),
                              DataCell(SizedBox(
                                width: AppTableWidths.phone,
                                child: Center(child: Text(m.phone ?? '-', style: cellStyle)),
                              )),
                              DataCell(SizedBox(
                                width: AppTableWidths.parcelType,
                                child: Center(child: Text(m.parcelType, style: cellStyle)),
                              )),
                              DataCell(SizedBox(
                                width: AppTableWidths.number,
                                child: Center(child: Text(m.numberOfParcel.toString(), style: cellStyle)),
                              )),
                              DataCell(SizedBox(
                                width: AppTableWidths.cashAdvance,
                              ...
                              DataCell(SizedBox(
                                width: AppTableWidths.cashAdvance,
                                child: right(Format.money(m.paymentPending ?? 0)),
                              )),
                              DataCell(SizedBox(
                                width: AppTableWidths.cashAdvance,
                        ...
                        if (list.isNotEmpty)
                          DataRow(
                            color: const MaterialStatePropertyAll(Color(0xFFF2F4F7)),
                            cells: [
                              ...
                              const DataCell(Align(
                                alignment: Alignment.centerRight,
                                child: Text('Totals', style: TextStyle(fontWeight: FontWeight.w700)),
                              )),
                              DataCell(SizedBox(
                                width: AppTableWidths.number,
                                child: Center(
                                  child: Text(
                                    list.fold<int>(0, (s, m) => s + m.numberOfParcel).toString(),
                                    style: const TextStyle(fontWeight: FontWeight.w700),
                                  ),
                                ),
                              )),
                              DataCell(SizedBox(
                                ...
                                child: Align(
                                  alignment: Alignment.centerRight,
                                  child: Text(
                                    Format.money(list.fold<double>(0, (s, m) => s + (m.cashAdvance ?? 0))),
                                    style: const TextStyle(fontWeight: FontWeight.w700),
                                  ),
                                ),
                              )),
                              DataCell(SizedBox(
                                ...
                                child: Align(
                                  alignment: Alignment.centerRight,
                                  child: Text(
                                    Format.money(list.fold<double>(0, (s, m) => s + (m.paymentPending ?? 0))),
                                    style: const TextStyle(fontWeight: FontWeight.w700),
                                  ),
                                ),
                              )),
                              DataCell(SizedBox(
                                ...
                                child: Align(
                                  alignment: Alignment.centerRight,
                                  child: Text(
                                    Format.money(list.fold<double>(0, (s, m) => s + (m.paymentPaid ?? 0))),
                                    style: const TextStyle(fontWeight: FontWeight.w700),
                                  ),
                                ),
                              )),
